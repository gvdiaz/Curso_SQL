...
CREATE INDEX Ind_cond ON conductor
(
dni DESC
);
...
CREATE INDEX Ind_paq ON paquete
(
IdConductor ASC
);
...
CREATE INDEX Ind_cam ON camion
(
patente DESC
);
...
CREATE INDEX Ind_dest ON destinatario
(
fecha_entrega DESC
);
...
CREATE INDEX Ind_rem ON remitente
(
fecha_envio DESC
);
